...
namespace NextTurn.Infrastructure.Migrations
{
    ...
    [Migration("20260315084026_AddAppointmentScheduleRules")]
    partial class AddAppointmentScheduleRules
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NextTurn.Domain.Appointment.Entities.Appointment", b =>
                {
                    ...
                    b.HasIndex("OrganisationId", "SlotStart")
                        .HasDatabaseName("IX_Appointments_OrganisationId_SlotStart");

                    b.HasIndex("OrganisationId", "SlotStart", "SlotEnd")
                        .IsUnique()
            ...
            modelBuilder.Entity("NextTurn.Domain.Appointment.Entities.AppointmentScheduleRule", b =>
                {
                    ...
                    b.HasIndex("OrganisationId", "DayOfWeek")
                        .IsUnique()
